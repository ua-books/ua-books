...
zubr = FactoryGirl.create(:book, :published, :with_cover, title: "Зубр шукає гніздо", publisher: leva_publishing)
vedmid = FactoryGirl.create(:book, :published, :with_cover, title: "Ведмідь не хоче спати", publisher: leva_publishing)
...
FactoryGirl.create(:admin, :dev_auth, email: "admin@ua-books.test")
FactoryGirl.create(:publisher_user, :dev_auth, email: "lev@ua-books.test", publisher: leva_publishing)
